...
namespace Customers.Domain.ViewHelper
{
    ...
    public class CompareValuesAttribute : ValidationAttribute
    {
        ...
        /// <summary>
        /// Determines whether the specified value of the object is valid.  For this to be the case, the objects must be of
        /// the same type and satisfy the comparison criteria. Null values will return false in all cases except when both
